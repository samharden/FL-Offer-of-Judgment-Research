...
5. ✅ **Practitioner checklist** — **done August 11, 2026**, and delivered as a full **practice guide** rather than a checklist: `practice-guide.md`, twelve parts, with the checklist as a one-page appendix. HTML build at `visuals/practice-guide.html`, generated from the Markdown.
   - Anchored on the *Anderson* / *Audiffred* line as planned — a proposal becomes "joint" when it **speaks for or binds** another party — and carries every trap this file listed: rule 1.442(f)(1) excludes Fla. R. Jud. Admin. 2.514(b); a rule 1.090 motion does **not** toll acceptance (*Koppel*); offers may not be aggregated (*Anderson*); dismissal must be **with prejudice** (*MX Investments*).
   - ⭐ **Two things the plan did not anticipate, and both earned their place.** The ***Gorka*** / all-or-nothing **structural** distinction (one offeror → many offerees is invalid; many offerors → one offeree is not), and the **conjunctive 25% test** that an all-or-nothing allocated offer creates — every claimant must independently beat their allocated share or none recovers. Both come from *Hoang Dinh Duong*; neither is in the Supreme Court corpus.
   - **All 41 case citations re-verified** August 11, 2026 against CourtListener. Every case name in the guide is hyperlinked — 191 mentions, 48 distinct cases.
